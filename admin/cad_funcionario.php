        ...
        <div id="templatemo_wrapper">
            ...
            <div id="templatemo_main">
                ...
                <div id="content" class="faq">
                    ...
                    <form name="form" method="POST" action="salvar_funcionario.php">
                        Usuario<input type="text" name="usuario" size="70" placeholder="Low" />
                        <p></p>
                        Senha<input type="password" name="senha" size="70" placeholder="***************" />
                        <p></p>
